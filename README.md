...
The screenshots currently depict the previous single-button interface. The
generator must be updated to draw the current panel before the next
submission — rerunning it alone will not fix that.
